.data
    ...
    palabras: .space 100    // Espacio del buffer donde guarda las palabras leidas de archivo.txt
...
msg_bienvenida:     .asciz "\nBienvenido "
    ...
    //formato_ranking: .asciz "%s %d\n"  // Formato para guardar nombre y puntos
    msg_ultimos: .asciz "\n=== ultimos 3 jugadores ===\n"
...
guardar_ranking:
    ...
    mov r1, #2              // O_RDWR
    mov r2, #0644          // Permisos del archivo (rw-r--r--)
    swi 0
    ...
    // Buscar el final del archivo usando lseek
    mov r7, #19            // Syscall para lseek
...
escribir_ranking:    
    ...
    mov r2, #0              // Contador para longitud real
...
fin_contar:    
    ...
    mov r0, r5
    bl int_to_str          // Convertir numero a string
    
    mov r7, #4
    mov r0, r4
    ldr r1, =buffer_temp   // Buffer donde esta el numero convertido
    mov r2, r0             // Longitud del numero retornada por int_to_str
    swi 0
...
leer_ultimos:
    ...
    mov r2, #1024          // Tama�o m�ximo a leer
    swi 0
...
fin_mostrar:
    ...
    add r0, r0, r6          // Posici�n desde donde mostrar
    bl print_palabra
...
int_to_str:
    ...
    mov r4, r0              // Guardar numero original
    ldr r5, =buffer_temp
...
convertir_numero:
    ...
    // Dividir por 10
    udiv r8, r4, r7         // r8 = cociente
    mul r9, r8, r7          // r9 = cociente * 10
    sub r9, r4, r9          // r9 = resto
    
    // Convertir d�gito a ASCII
    add r9, r9, #'0'
    strb r9, [r5, r6]
    add r6, r6, #1
    
    mov r4, r8              // Preparar siguiente iteracion
    b convertir_numero
...
leer_palabras:
    ...
    //ldr r1, =mensaje1       // Cargar dirección del mensaje
    ...
    //mov r7, #4              // Syscall para escribir
    //mov r0, #1              // Salida estándar
    //ldr r1, =buffer         // Buffer con contenido
    //mov r2, r5              // Cantidad de bytes leídos
    //swi 0
...
loop_juego:
    ...
    @ Incrementar seed basado en n�mero de partida
    ldr r0, =num_partida
    ldr r0, [r0]        //traigo el nro de partida actual
    mov r1, #42         //base seed
